"""ensemble_trainer.py
Full-featured Ensemble Trainer (LightGBM + XGBoost) for binary & multiclass classification,
dengan metric trading yang lebih tepat: Profit-Weighted Accuracy, Balanced Accuracy, dan High-Confidence Accuracy.
"""
...
import time
from data_processing.detect_market_regime import detect_market_regime_series
...
# Opsional ONNX export (akan dipakai kalau user butuh)
try:
